...
<head>
    ...
    <meta name="description"
        content="Get access to 500+ programming tutorials from top instructors. Learn Python, Java, JavaScript, Web Development, AI, Machine Learning and more.">
...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto px-6 py-12 mt-8" >
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center relative z-10">
                ...
                <div>
                    ...
                    <form class="relative max-w-xl">
                        ...
                        <button type="submit"
                            class="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 bg-teal-600 text-white rounded-full flex items-center justify-center hover:bg-teal-700">
                ...
                <div class="relative hidden lg:block">
                    ...
                    <div class="relative z-10 ml-auto max-w-md">
                        <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=500&fit=crop"
                            alt="Student" class="rounded-2xl shadow-2xl w-full">
                    </div>
                    ...
                    <div class="absolute -left-8 top-20 z-20 bg-yellow-400 rounded-2xl shadow-xl p-4 w-48">
                        <img src="https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200&h=200&fit=crop"
                            alt="Student" class="rounded-lg w-full">
                    </div>
                    ...
                    <!-- Decorative Triangle -->
                    <div
                        class="absolute -right-8 top-1/2 w-16 h-16 border-t-[32px] border-t-transparent border-l-[56px] border-l-orange-400 border-b-[32px] border-b-transparent opacity-60">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="mb-16">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-4 mb-12">
                <!-- Python -->
                <a href="#"
                    class="group block bg-white rounded-xl p-6 text-center transition-all duration-300 hover:shadow-lg hover:-translate-y-1 no-underline border border-gray-100">
                ...
                <a href="#"
                    ...
                    <div class="w-16 h-16 mx-auto mb-3 flex items-center justify-center">
                        <svg class="w-12 h-12" viewBox="0 0 24 24" fill="currentColor">
                            <path
                                d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.6 0 12 0zm0 2c5.5 0 10 4.5 10 10s-4.5 10-10 10S2 17.5 2 12 6.5 2 12 2z"
                                class="text-gray-800" />
                        </svg>
                    </div>
                ...
                <a href="#"
                    ...
                    <div class="w-16 h-16 mx-auto mb-3 flex items-center justify-center">
                        <svg class="w-14 h-14" viewBox="0 0 24 24" fill="#EE4C2C">
                            <path
                                d="M12.005 0L3.952 8.053c-5.27 5.27-5.27 13.82 0 19.091 5.27 5.27 13.819 5.27 19.09 0 5.27-5.27 5.27-13.82 0-19.09l-6.024-6.025v4.994l3.013 3.013c3.16 3.16 3.16 8.287 0 11.447-3.16 3.16-8.286 3.16-11.446 0-3.16-3.16-3.16-8.287 0-11.447L12.005 6z" />
                        </svg>
                    </div>
                ...
                <a href="#"
                    ...
                    <div class="w-16 h-16 mx-auto mb-3 flex items-center justify-center">
                        <svg class="w-14 h-14" viewBox="0 0 24 24">
                            <path fill="#130754"
                                d="M16.922 0h2.623v18.104h-2.623zm-5.653 3.478h2.622v18.104h-2.622zm-5.652 3.565h2.623v18.104H5.617z" />
                    ...
                    <div class="w-16 h-16 mx-auto mb-3 flex items-center justify-center">
                        <svg class="w-12 h-12" viewBox="0 0 24 24" fill="#CC0000">
                            ...
                            <text x="12" y="16" text-anchor="middle" fill="white" font-size="10"
                                font-weight="bold">CGI</text>
                        </svg>
                    </div>
                    <h3 class="text-sm font-medium text-gray-700 group-hover:text-gray-900">Python CGI<br />Programming
                    </h3>
                </a>
            </div>
                ...
                <a href="#"
                    ...
                    <div class="w-16 h-16 mx-auto mb-3 flex items-center justify-center">
                        <svg class="w-14 h-14" viewBox="0 0 24 24" fill="#A8B9CC">
                            <path
                                d="M16.5922 9.1807C15.5018 7.6842 13.7523 6.7617 11.8177 6.7617c-3.7203 0-6.7344 3.0141-6.7344 6.7344s3.0141 6.7344 6.7344 6.7344c1.9346 0 3.6841-.9225 4.7745-2.419l-3.1646-1.8274c-.5143.7485-1.3738 1.2426-2.3644 1.2426-1.5663 0-2.8361-1.2698-2.8361-2.8361s1.2698-2.8361 2.8361-2.8361c.9906 0 1.8501.494 2.3644 1.2426z" />
                        </svg>
                    </div>
        ...
        <section class="mb-16">
            <div
                class="grid lg:grid-cols-2 gap-12 items-center bg-gradient-to-br from-gray-50 to-white rounded-3xl p-12">
                <!-- Left - Image -->
                <div class="relative">
                    <div class="relative inline-block">
                        <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&h=400&fit=crop"
                            alt="YouTube" class="rounded-2xl shadow-xl">
                        <div class="absolute top-8 -right-12 bg-yellow-400 rounded-2xl p-4 shadow-xl">
                            <div class="text-center">
                                <div
                                    class="w-12 h-12 bg-white rounded-full mx-auto mb-2 flex items-center justify-center">
                    ...
                    <!-- Decorative Circle -->
                    <div class="absolute -bottom-8 -left-8 w-32 h-32 border-8 border-teal-500 rounded-full -z-10">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <a href="#"
                        class="inline-flex items-center gap-2 bg-gray-900 text-white px-8 py-4 rounded-lg font-semibold hover:bg-gray-800 transition-all">
        ...
        <section class="mb-16">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Column 1 -->
                <ul class="space-y-3">
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Exception
                            Handling</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Try Catch</a>
                    </li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Multiple
                            Catch</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Nested
                            Try</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Finally
                            Block</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Throw</a>
                    </li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Exception
                            Propagation</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Throws</a>
                    </li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Throw vs
                            Throws</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Final vs
                            Finally vs Finalize</a></li>
                </ul>

                <!-- Column 2 -->
                <ul class="space-y-3">
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Exception
                            Handling with Overriding</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Custom
                            Exception</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Inner
                            Classes</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Member Inner
                            Class</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Anonymous
                            Inner Class</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Local Inner
                            Class</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Static Nested
                            Class</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Nested
                            Interface</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java
                            Multithreading</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Thread Life
                            Cycle</a></li>
                </ul>

                <!-- Column 3 -->
                <ul class="space-y-3">
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Create
                            Thread</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Thread
                            Scheduler</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Thread
                            Sleep</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Start Thread
                            Twice</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java run vs
                            start</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Thread
                            Join</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Thread
                    ...
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Thread
                            Priority</a></li>
                    <li><a href="#" class="text-teal-700 hover:text-teal-900 hover:underline">Java Daemon
                            Thread</a></li>
                </ul>
            </div>
        </section>
    ...
    <button onclick="window.scrollTo({top: 0, behavior: 'smooth'})"
        class="fixed bottom-8 right-8 w-14 h-14 bg-teal-500 text-white rounded-full shadow-lg hover:bg-teal-600 transition-all flex items-center justify-center z-50">
