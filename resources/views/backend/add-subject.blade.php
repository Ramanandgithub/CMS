...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 rounded-2xl p-6 md:p-8 text-white shadow-xl">
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold mb-2">Mobile Recharge</h1>
                <p class="text-blue-200">Recharge your mobile instantly</p>
            </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        <div class="bg-white rounded-xl p-6 shadow-lg">
            ...
            <h3 class="text-gray-500 text-sm font-medium mb-1">Total Recharges</h3>
    ...
    <div id="rechargeForm" class="bg-white rounded-xl shadow-lg p-6" style="display: none;">
        <h3 class="text-xl font-bold text-gray-900 mb-6">Quick Recharge</h3>
        ...
        <form class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="tel" id="mobileNumber" maxlength="10" placeholder="Enter 10 digit mobile number" class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:outline-none">
                </div>

                <!-- Operator -->
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Select Operator</label>
                    <select id="operator" onchange="loadPlans()" class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:outline-none">
                ...
                <!-- Circle -->
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Circle</label>
                    <select id="circle" class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:outline-none">
                ...
                <div>
                    ...
                    <input type="number" id="amount" placeholder="₹ Enter amount" class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:outline-none">
                </div>
            </div>

            <!-- Popular Plans -->
            <div id="popularPlans" style="display: none;">
                <h4 class="text-lg font-bold text-gray-900 mb-4">Popular Plans</h4>
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4" id="plansContainer">
