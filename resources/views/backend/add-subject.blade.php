            ...
            <div class="modal-content">
                <form id="addSupportForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-2"><label>Subject Name</label><input type="text" name="subject" class="form-control" required></div>
                        <div class="form-group mb-2"><label>Slug Name</label><input type="text" name="slug" class="form-control" required></div>
                        
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn buttonColor" id="btnSubmit">Save Subject</button>
                    </div>
                </form>
            </div>
        </div>
