...
$(document).ready(function() {
    ...
    rechargeTable = $('#rechargeTable').DataTable({
        ...
        ajax: {
            url: '/fetch/subjects/0',   // Laravel route
            type: 'POST',
        ...
        columns: [
            ...
            { 
                ...
                render: function(data) {
                    const badges = {
                        'success': '<span class="px-3 py-1 text-xs font-semibold text-green-700 bg-green-100 rounded-full">Active</span>',
                        'pending': '<span class="px-3 py-1 text-xs font-semibold text-yellow-700 bg-yellow-100 rounded-full">Inactive</span>',
                ...
                render: function(data, type, row) {
                    return `
                        <div class="flex gap-2">
                            ...
                            <button class="px-3 py-1 bg-red-600 text-white text-xs font-semibold rounded hover:bg-red-700 transition-colors">
                                Delete
                            </button>
                        </div>
                    `;
